...
and the importance of a proper recommendation system has always been fundamental.
...
This repository proposes two main improvement to the original model: a Multi-Head Attention module 
...
2. in the information layer, we replaced the self-attention module with a multi-head attention module
...
After preprocessing the dataset with BERT, each DV should be structured with:
- News ID
